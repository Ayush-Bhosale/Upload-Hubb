...
http.listen(4000, function () {
    ...
    mongoClient.connect("mongodb+srv://CoduxAyush:MShinzo69@cluster0.sejv8jr.mongodb.net/?retryWrites=true&w=majority", {
                ...
                if (request.files.file.size > 0) {
                    ...
                    fileSystem.readFile(request.files.file.path, function (err, data) {
                        ...
                        fileSystem.writeFile(filePath, data, async function (err) {
                            ...
                            request.session.status = "success";
                            request.session.message = "Sucesss !!! File has been uploaded.";
